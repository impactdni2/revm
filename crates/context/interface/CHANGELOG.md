...
## [6.0.0](https://github.com/impactdni2/revm/compare/revm-context-interface-v5.0.0...revm-context-interface-v6.0.0) - 2025-06-02

### Added

- Config blob basefee fraction ([#2551](https://github.com/impactdni2/revm/pull/2551))
- expand timestamp/block_number to u256 ([#2546](https://github.com/impactdni2/revm/pull/2546))
- transact multi tx ([#2517](https://github.com/impactdni2/revm/pull/2517))

### Other

- *(docs)* add lints to database-interface and op-revm crates ([#2568](https://github.com/impactdni2/revm/pull/2568))
- *(docs)* context crate lints ([#2565](https://github.com/impactdni2/revm/pull/2565))
- ContextTr rm *_ref, and add *_mut fn ([#2560](https://github.com/impactdni2/revm/pull/2560))
- *(cfg)* add tx_chain_id_check fields. Optimize effective gas cost calc ([#2557](https://github.com/impactdni2/revm/pull/2557))
